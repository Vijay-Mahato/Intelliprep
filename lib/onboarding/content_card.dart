...
class ContentCard extends StatefulWidget {
  ...
  const ContentCard({super.key, required this.color, this.title = "", required this.subtitle, required this.altColor,  required this.onButtonPressed});
              ...
              child: Padding(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    //Slider circles
                    SizedBox(height: 14, child: Image.asset('images/Slider-${widget.color}.png', package: App.pkg)),
